...
public class VideoProductionJob {
    ...
    private static String storageName(AlertEvent a){String station=a.stationName().replaceAll("[^가-힣A-Za-z0-9_-]","_").replaceAll("_+","_");String time=DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss").withZone(ZoneId.of("Asia/Seoul")).format(a.triggeredAt());return station+"_"+time;}
